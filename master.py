...
- Immediate targeted OHLC initialization (historical + live 0) and /param calculation for additions.
- Admin-level targeted database purge (/stocks, /param, and /display_list/stocks) on deletion.
...
class MasterOrchestrator:
    ...
    def handle_stock_addition(self, stock_name: str, ticker: str):
        """Seeds 300 historical bars, initializes live row 0, and calculates technical parameters."""
        ...
        if success:
            ...
            # Populate technical parameters immediately
    ...
    def handle_stock_deletion(self, stock_name: str):
        """Purges OHLC database, technical parameters, and monitor display references on deletion."""
        safe_key = sanitize_key(stock_name)
        ...
        # 3. Purge stock entry from monitor display_list
        try:
